                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        @endif
                            ...
                            <form action="{{route('posyandu.update',$data->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            @method('PATCH')
                               @csrf
                               <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Posyandu</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_namaposyandu" value="{{$data->nama_posyandu}}" placeholder="Text" class="form-control"><small class="form-text text-muted">Isikan dengan nama posyandu yang ingin ditambahkan</small></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Alamat Posyandu</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_alamatposyandu" value="{{$data->alamat_posyandu}}" placeholder="Text" class="form-control"><small class="form-text text-muted">Isikan dengan alamat posyandu yang ingin ditambahkan</small></div>
                                </div>
