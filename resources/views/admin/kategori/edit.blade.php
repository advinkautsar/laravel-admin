                            ...
                            @method('PATCH')
                               @csrf
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_namakategori" value="{{$data->nama_kategori}}" placeholder="Text" class="form-control"><small class="form-text text-muted">Isikan dengan nama kategori yang sedang ditugaskan</small></div>
                                </div>
                               
                                
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Keterangan Kategori</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_ketkategori" value="{{$data->ket_kategori}}"placeholder="Text" class="form-control"><small class="form-text text-muted">Penjelasan Mengenai Kategori Tugas yang disematkan</small></div>
                                </div>
