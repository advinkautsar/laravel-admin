                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        @endif
                            ...
                            <form action="{{route('kader.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                               @csrf
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Kader</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_namakader" placeholder="Text" class="form-control"><small class="form-text text-muted">Isikan dengan nama kader yang ditugaskan</small></div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_alamatkader" placeholder="Text" class="form-control"><small class="form-text text-muted">Alamat Rumah Kader</small></div>
                                </div>

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Telp Kader</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_telpkader" placeholder="Text" class="form-control"><small class="form-text text-muted">No Telepone Kader</small></div>
                                </div>

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password </label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_passwordkader" placeholder="Text" class="form-control"><small class="form-text text-muted">Password</small></div>
                                </div>                             
