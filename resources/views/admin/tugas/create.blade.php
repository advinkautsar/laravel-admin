                            ...
                            <form action="{{route('tugas.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                               @csrf
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_namatugas" placeholder="Text" class="form-control"><small class="form-text text-muted">Isikan dengan nama tugas yang sedang ditugaskan</small></div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_kettugas" placeholder="Text" class="form-control"><small class="form-text text-muted">Penjelasan Mengenai Tugas yang disematkan</small></div>
                                </div>
