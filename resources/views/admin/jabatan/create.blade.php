                            ...
                            <form action="{{route('jabatan.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                               @csrf
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kode Jabatan</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_kodejabatan" placeholder="Text" class="form-control"><small class="form-text text-muted">Isikan dengan nama tugas yang sedang ditugaskan</small></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Jabatan</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_namajabatan" placeholder="Text" class="form-control"><small class="form-text text-muted">Penjelasan Mengenai Tugas yang disematkan</small></div>
                                </div>

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Gaji</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_gaji" placeholder="Text" class="form-control"><small class="form-text text-muted">Penjelasan Mengenai Tugas yang disematkan</small></div>
                                </div>
